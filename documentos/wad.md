...
- **Arquitetura MVC:** Facilita a organização do código e melhor entendimento de cada parte de sua estrutura. Também possibilita a resolução de bugs e possiveis erros no código de forma mais ágil.
